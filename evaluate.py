# -*- coding: utf-8 -*-
"""Copy of evaluation_script.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1nHrYmyGPhlmv6BQdRH3wOqvAHpNMWIuf
"""
...
with open(r"/data/snehaoladhri/results/ppbm_fold"+str(fold)+".pkl", "rb") as input_file:
  e = cPickle.load(input_file)
feat=np.array(list(e.values()))

# r=np.array(list(e.values()))
#dist_matrix=distance(r)
...
for k,i in enumerate(ids):
  ind=ids[np.delete(np.argsort(dist_matrix[k],kind='mergesort'),k)]
  dict_res={"query_id":ids[k].tolist(),"ans_ids":ind.tolist()}
  final_res.append(dict_res)
  
with open("/data/snehaoladhri/results/data_"+str(fold)+".pkl", 'w') as f:
    json.dump(final_res, f)
print(p.evaluate('../annotations/gt_test_plain.json',"/data/snehaoladhri/results/data_"+str(fold)+".pkl",'test'))
